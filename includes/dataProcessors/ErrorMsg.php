...
class ErrorMsg {
   ...
   public static $register = "<div class='alert alert-warning'>A fatal error ocurred during registration</div>";
   public static $login = "<span class='errorMessage'>Invalid username and password</span>";
   ...
   public static $detailsUpdate = "<div class='alert alert-warning'>Your details update failed</div>";

   public static $passwordUpdate = "<div class='alert alert-warning'>Your password update failed</div>";
   ...
   public static $image = "<div class='alert alert-danger'>Error uploading image</div>";
